    ...
    <el-row>
      ...
      <el-col :span="20">
        <div style="border:1px solid #ebeef5;height:44px;line-height:34px;  padding: 5px 5px; background-color: #f5f5f5;color: #999;
          ...
          <el-button size="small" class="fr ml10" icon="el-icon-plus" @click="addControl()">增加控件</el-button>
          <el-button size="small" class="fr" icon="el-icon-tickets"  @click="addMenu()">增加菜单</el-button>
        </div>
        <!-- 表格内容开始-->
...
export default {
  ...
  methods: {
    ...
    // 自己的
    organInfo() {
      this.$router.push({ name: "organInfo-demo" });
    },
    userList() {
      this.$router.push({ name: "userList-demo" });
    },
    addControl() {
      alert("1");
    },

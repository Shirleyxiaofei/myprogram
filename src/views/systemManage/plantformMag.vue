<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="filter-container">
      <el-button class="filter-item" @click="handleCreate" type="primary" icon="el-icon-plus">{{'新建平台'}}</el-button>
    </div>
    <!-- 表格顶部结束-->
    <!-- 表格内容开始-->
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" stripe fit highlight-current-row
      ...
      <el-table-column width="150px" align="center" label="平台名称">
         <template slot-scope="scope">
      ...
      <el-table-column width="150px" align="center" label="平台系统编码">
        <template slot-scope="scope">
          <span>{{scope.row.author}}</span>
        </template>
      </el-table-column>
      <el-table-column width="210px"  align="center" label="创建版本号">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="85px" style='width: 400px; margin-left:50px;'>
        <el-form-item label="平台名称" prop="type">
          <el-input v-model="temp.title"></el-input>
        </el-form-item>
        <el-form-item label="平台编码" prop="timestamp">
          <el-input v-model="temp.title"></el-input>
        </el-form-item>
        <el-form-item label="平台版本" prop="title">
          <el-input v-model="temp.title"></el-input>
        </el-form-item>
        <el-form-item label="平台状态" prop="title">
        ...
        <el-form-item label="平台URL" prop="title">
          <el-input v-model="temp.title"></el-input>          
        </el-form-item>
      </el-form>

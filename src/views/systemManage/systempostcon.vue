<template>
  <div class="spc">
    <div class="pmg-top">
      <span class="pmg-title">系统岗位查询</span>
      <div class="line"></div>
      <div class="pmg-form">
        <el-form :inline="true"
          :model="formInline"
    ...
    <div class="pmg-content">
      <span class="pmg-title">系统岗位列表</span>
      <div class="line"></div>
    ...
    <el-dialog
      ...
      <el-form
        ...
        <el-form-item label="系统岗位描述 :">
          <el-input v-model="form.usernum"></el-input>
        </el-form-item>
        <el-form-item label="系统岗位状态 :">
          <el-input v-model="form.name"></el-input>
        </el-form-item>
        <el-form-item label="系统岗位编码 :">
          <el-input v-model="form.name"></el-input>
        </el-form-item>
        <el-form-item label="父级岗位编号 :">
          <el-input v-model="form.name"></el-input>
        </el-form-item>
        <el-form-item label="管理组织编号 :">
          <el-input v-model="form.name"></el-input>
        </el-form-item>
        <el-form-item label="系统岗位类型 :">
          <el-input v-model="form.name"></el-input>
        </el-form-item>
      </el-form>
...
.spc .el-dialog__body .el-input--medium .el-input__inner {
  width: 98%;
}
.el-dialog__header {
  background: #0084ff;
